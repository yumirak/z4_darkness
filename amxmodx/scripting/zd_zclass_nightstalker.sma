...
public Load_ClassConfig()
{
	...
	formatex(zclass_name, sizeof(zclass_name), "%L", LANG_SERVER, "ZOMBIE_CLASS_NIGHTSTALKER_NAME")
	formatex(zclass_desc, sizeof(zclass_desc), "%L", LANG_SERVER, "ZOMBIE_CLASS_NIGHTSTALKER_DESC")
	...
	Setting_Load_String(SETTING_FILE, "Zombie Class", "CLASS_NIGHTSTALKER_KNOCKBACK", Temp, sizeof(Temp)); zclass_knockback = str_to_float(Temp)
	Setting_Load_String(SETTING_FILE, "Zombie Class", "CLASS_NIGHTSTALKER_DEFENSE", Temp, sizeof(Temp)); zclass_defense = str_to_float(Temp)
	...
	Setting_Load_String(SETTING_FILE, "Zombie Class", "CLASS_NIGHTSTALKER_DEATHSOUND", zclass_deathsound, sizeof(zclass_deathsound))
	Setting_Load_String(SETTING_FILE, "Zombie Class", "CLASS_NIGHTSTALKER_PAINSOUND1", zclass_painsound1, sizeof(zclass_painsound1))
	Setting_Load_String(SETTING_FILE, "Zombie Class", "CLASS_NIGHTSTALKER_PAINSOUND2", zclass_painsound2, sizeof(zclass_painsound2))
	Setting_Load_String(SETTING_FILE, "Zombie Class", "CLASS_NIGHTSTALKER_STUNSOUND", zclass_stunsound, sizeof(zclass_stunsound))
