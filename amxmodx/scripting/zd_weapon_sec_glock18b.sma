...
#define PLUGIN "[ZD] Secondary Weapon: Glock-18"
#define VERSION "1.0"
#define AUTHOR "Dias"
...
#define V_MODEL "models/ZombieDarkness/Weapon/Sec/v_bglock18.mdl"
#define P_MODEL "models/ZombieDarkness/Weapon/Sec/p_bglock18.mdl"
#define W_MODEL "models/ZombieDarkness/Weapon/Sec/w_bglock18.mdl"
...
new g_Glock18
new g_Had_BWGlock, g_EventGlock18, PShell_Index, g_SmokePuff_SprId, g_InSpecialShoot, g_MaxPlayers
...
public plugin_init()
{
	...
	register_event("CurWeapon", "Event_CurWeapon", "be", "1=1", "2=17")
	...
	g_Glock18 = zd_weapon_register("Glock 18C Extreme", WEAPON_SECONDARY, CSW_GLOCK18, 1500)
}
...
public Event_CurWeapon(id)
{
	...
	Delay = get_pdata_float(Ent, 46, 4) * SPECIALSHOOT_DELAY
	Delay2 = get_pdata_float(Ent, 47, 4) * SPECIALSHOOT_DELAY
